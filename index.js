...
//
const BotName = 'BOT ./sansbot'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/rioputra.x/'; // Nama Instagramlu cok
const whatsapplu = '0821-4047-4679'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/EshQTqHyPTp7VBGclqc8jy'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/K6daz7vx6cmLKruZATahCF'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
